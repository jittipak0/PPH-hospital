...
แพ็กเกจนี้สร้างขึ้นอัตโนมัติจากเว็บไซต์โรงพยาบาลโพนพิสัย (${origin}) เพื่อช่วยให้คุณสร้างแอป
...
ไฟล์ในโฟลเดอร์นี้คือโปรเจกต์ตัวอย่างที่ใช้ \`ComponentActivity\` และ \`WebView\` ของ Android เพื่อโหลดเว็บไซต์โรงพยาบาลโพนพิสัย (${origin}).
...
ชุดไฟล์นี้ใช้ SwiftUI และ WKWebView เพื่อโหลดเว็บไซต์โรงพยาบาลโพนพิสัย (${origin}).
    ...
    var body: some View {
        NavigationView {
            WebView(url: hospitalURL)
                .navigationTitle("โรงพยาบาลโพนพิสัย")
