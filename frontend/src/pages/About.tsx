...
export const About: React.FC = () => {
  return (
    <div>
      <Container>
        <header>
          <h1>เกี่ยวกับโรงพยาบาลประชารัฐ</h1>
          <p>
            โรงพยาบาลประชารัฐเป็นโรงพยาบาลศูนย์ของภาครัฐ ก่อตั้งในปี พ.ศ. 2508 ด้วยพันธกิจในการให้บริการทางการแพทย์ที่มีคุณภาพและเข้าถึงได้สำหรับประชาชนทุกกลุ่ม
          </p>
        </header>
      </Container>
